    ...
    function content($text) {
      ...
      if(get_the_ID() == $options['post_id']) {
        ...
        if ($options['attribution']) {
          $text .= '<div id="jobamatic-attribution"><a href="" target="_blank" title="Powered by SimplyHired."><img src="' .
              $this->plugin_url . '/img/Logo_SHpartner.png" height="20" width="150" alt="Powered by SimplyHired" /></a></div>';
        }
      }
      return $text;
    }
